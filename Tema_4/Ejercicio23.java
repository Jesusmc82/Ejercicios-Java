...
public class Ejercicio23 {
  public static void main(String[] args) {
    ...
    System.out.print("¿Qué tipo de IVA es? (general, reducido o superreducido): ");
    String iva = System.console().readLine().toLowerCase();
    System.out.print("\n¿Qué codigo promocional posee? (nopromo, mitad, -5€ o 5%): ");
    ...
    if (baseImp < 0) {
      System.out.println("Las bases imponibles no pueden ser negativas");
      ...
      System.out.println("Algún caracter no es correcto.");
    }
  }
}
